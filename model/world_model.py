...
from Transformer_World_Model.utils                      import LossWithIntermediateLosses, init_weights
from Transformer_World_Model.model.kv_caching           import KeyValues
from Transformer_World_Model.model.transformer          import Transformer, TransformerConfig
from Transformer_World_Model.model.tokenizer.tokenizer  import Tokenizer
from Transformer_World_Model.model.slicer               import Embedder, Head
...
class WorldModel(nn.Module):
    ...
    def forward(self, tokens: torch.LongTensor, past_keys_values: Optional[KeyValues] = None) -> WorldModelOutput:
